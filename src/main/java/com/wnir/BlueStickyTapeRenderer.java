...
public class BlueStickyTapeRenderer implements SpecialModelRenderer<BlockState> {
    ...
    public void submit(
        ...
        RenderType blockRt = RenderTypes.itemEntityTranslucentCull(atlasId);
    ...
    private static TextureAtlasSprite getBestSprite(BlockState state, Minecraft mc) {
        ...
        // collect once for all face queries
    ...
    private static @Nullable RenderType getCrossRenderType() {
        ...
        crossRenderType = RenderTypes.itemEntityTranslucentCull(CROSS_TEXTURE_ID);
    ...
    public static final class Unbaked implements SpecialModelRenderer.Unbaked {
        @Override
        public MapCodec<? extends SpecialModelRenderer.Unbaked> type() { return MAP_CODEC; }
