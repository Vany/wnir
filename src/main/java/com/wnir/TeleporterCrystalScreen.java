...
/**
 * Progress GUI for TeleporterCrystalBlock.
 *
 ...
 */
public class TeleporterCrystalScreen extends AbstractContainerScreen<TeleporterCrystalMenu> {

    private static final Identifier BACKGROUND =
        Identifier.fromNamespaceAndPath(WnirMod.MOD_ID, "textures/gui/container/teleporter_crystal.png");
    ...
    private static final int COLOR_BAR_PROGRESS = 0xFF9955CC;
    private static final int COLOR_BAR_FUEL     = 0xFF44AADD;
    private static final int COLOR_WHITE        = 0xFFFFFFFF;
    private static final int COLOR_GRAY         = 0xFFAAAAAA;

    public TeleporterCrystalScreen(TeleporterCrystalMenu menu, Inventory inv, Component title) {
        super(menu, inv, title);
        imageWidth  = TeleporterCrystalMenu.IMG_W;
        imageHeight = TeleporterCrystalMenu.IMG_H;
    ...
    protected void renderLabels(GuiGraphics g, int mouseX, int mouseY) {
        ...
        if (menu.getProgress() >= 10000) {
            ...
            long ticksLeft = (long) TeleporterCrystalBlockEntity.BASE_TICKS
